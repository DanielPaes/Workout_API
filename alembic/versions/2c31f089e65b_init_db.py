...
Revision ID: 2c31f089e65b
Revises: 
Create Date: 2024-07-03 16:59:01.075443
...
def upgrade() -> None:
    ...
    sa.Column('centro_trienamento_id', sa.Integer(), nullable=False),
    sa.Column('id', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['categoria_id'], ['categorias.pk_id'], ),
    sa.ForeignKeyConstraint(['centro_trienamento_id'], ['centros_treinamento.pk_id'], ),
    sa.PrimaryKeyConstraint('pk_id'),
